...
| `asr_chunk_min_chars` | 500 / `ASR_CHUNK_MIN_CHARS` | brief 中 ASR 写作块最小字符数/词数 |
| `asr_chunk_max_chars` | 800 / `ASR_CHUNK_MAX_CHARS` | brief 中 ASR 写作块最大字符数/词数 |
...
| `scene_junk_filter` | true / `SCENE_JUNK_FILTER` | 场景检测后过滤近纯黑/纯白过渡场景 |
| `scene_junk_dark_luma` | 8 | 黑帧平均亮度阈值 |
| `scene_junk_bright_luma` | 245 | 白帧平均亮度阈值 |
| `scene_junk_pixel_ratio` | 0.995 | 黑/白像素占比阈值 |
